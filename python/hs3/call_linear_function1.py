...
class LinearRegression:
    ...
    def predict(area, bed, bath, wm, dtcen, hw, ac, pk, se, fn):
        # Replace 'your_data.csv' with the actual path to your CSV file
        file_path = 'Housing_data_final(8).csv'

        # Replace with the features you want to use
        num_vars = ['area', 'bedrooms', 'bathrooms', 'washingmachine','dtcenter', 'hotwater', 'ac', 'parking', 'security', 'furnish']
        ...
        user_input = [area, bed, bath, wm, dtcen, hw, ac, pk, se, fn]
        print(user_input)
